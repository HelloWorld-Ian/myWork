...
<div class="main">
  ...
  <el-descriptions :column="columns" title="计划基本信息">
  ...
  <el-descriptions-item label="计划执行人" v-if="plan.type=='个人计划'">{{plan.excutor}}</el-descriptions-item>
  <el-descriptions-item label="计划负责人" v-if="plan.type=='小组计划'">{{plan.manager}}</el-descriptions-item>
  <el-descriptions-item :label="'小组成员'+i" v-for="(item,i) in plan.member" :key="i">{{item}}</el-descriptions-item>
...
<div  v-for="(item,i) in process" :key="i">
  <el-descriptions :column="columns" :title="'任务'+(i+1)">
  ...
  <br>
     ...
     <el-descriptions :column="1" title="日志" direction="vertical">
...
<div  v-for="(item,i) in process" :key="i">
  ...
  <br>
    ...
    <el-descriptions :column="1" title="日志" direction="vertical" border>
      <el-descriptions-item v-for="(item,i) in logDate" :key="i" :label="item">
      {{notes.dailyNotes[item]}}
      </el-descriptions-item>
      </el-descriptions>
 ...
 <el-card shadow="never" v-if="type==4" class="typeCard">
...
<el-card shadow="never" v-if="type==2" class="typeCard">
  <el-descriptions :column="columns" title="计划基本信息" direction="vertical" >
  <el-descriptions-item label="计划名称">{{plan.name}}</el-descriptions-item>
  <el-descriptions-item label="计划性质">{{plan.type}}</el-descriptions-item>
  <el-descriptions-item label="计划执行人" v-if="plan.type=='个人计划'">{{plan.excutor}}</el-descriptions-item>
  <el-descriptions-item label="计划负责人" v-if="plan.type=='小组计划'">{{plan.manager}}</el-descriptions-item>
...
<br>
<div  v-for="(item,i) in process" :key="i">
  <el-descriptions :column="columns" :title="'任务'+(i+1)" direction="vertical" >
  <el-descriptions-item label="任务名称">{{item.pro_name}}</el-descriptions-item>
  <el-descriptions-item label="开始时间">{{item.startDate+item.startTime}}</el-descriptions-item>
  <el-descriptions-item label="结束时间">{{item.endDate+item.endTime}}</el-descriptions-item>
  <el-descriptions-item label="任务描述">{{item.pro_text}}</el-descriptions-item>
