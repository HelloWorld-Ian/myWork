<template>
   ...
   <div v-if="plan[todayProSelected.planIndex].plan.type!='个人计划'&&$store.state.login">
   ...
   <el-card v-if="plan[todayProSelected.planIndex].plan.type=='个人计划'||!$store.state.login">
